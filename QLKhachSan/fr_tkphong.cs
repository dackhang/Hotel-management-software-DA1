...
{
    public partial class fr_tkphong : Form
    {
        SqlConnection con;
        SqlCommand cmd;
        ...
        void Load_data()
        {
            ...
            cmd.CommandText = "SELECT P.MaPhong, P.LoaiPhong, P.GiaPhong, COUNT(HD.MaPhong) AS HoaDonCount, SUM(HD.TienPhong) AS TienPhongSUM FROM Phong P LEFT JOIN Hoa_Don HD ON P.MaPhong = HD.MaPhong GROUP BY P.MaPhong, P.LoaiPhong, P.GiaPhong";
            adt.SelectCommand = cmd;
            dt.Clear();
            adt.Fill(dt);
            dgv.DataSource = dt;
        }
        private void tk_phong_Load(object sender, EventArgs e)
        {
        ...
        private void thongke_Click(object sender, EventArgs e)
        {
            using (var excelPackage = new ExcelPackage())
            {
                ...
                worksheet.Cells["B2"].Value = "Sử dụng phòng khách sạn";
                ...
                worksheet.Cells["D5"].Value = "Loại Phòng";
                ...
                worksheet.Cells["E5"].Value = "Giá Phòng";
